addEventListener("DOMContentLoaded", () => 
    {
        ...
        commands = {
            ...
            about: "Software developer and engineer",
            clear: "clear",
        }
...
//     // From current postion to new position
//     // gsap.to(".item", {backgroundColor: 'blue', rotation: 360, duration: 4, stagger: 1} )



//     // setTimeout(() => {
//     //     // Animation from and end at current position
//     //     gsap.from(".item", {backgroundColor: 'blue', rotation: 360, duration: 10})
